...
| X-58 | Upload file quá dung lượng | Tại màn hình Thêm cán bộ:<br>1. Chọn file > 10MB tại [CV file] File.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo:"Dung lượng file không được vượt quá 10MB!"<br>Trỏ chuột tại [CV file] File. |
| [Màu đồng phục] Color |
| X-59 | Không chọn màu | Tại màn hình Thêm cán bộ:<br>1. Không chọn màu tại [Màu đồng phục] Color.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng chọn màu!"<br>Trỏ chuột tại [Màu đồng phục] Color. |
| [Đánh giá] Rating |
| X-60 | Không chọn mức đánh giá | Tại màn hình Thêm cán bộ:<br>1. Không chọn sao tại [Đánh giá] Rating.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng đánh giá!"<br>Trỏ chuột tại [Đánh giá] Rating. |
| [Chứng chỉ] Tag-input |
| X-61 | Không nhập tag chứng chỉ | Tại màn hình Thêm cán bộ:<br>1. Không nhập tag nào tại [Chứng chỉ] Tag-input.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng nhập ít nhất 1 chứng chỉ!"<br>Trỏ chuột tại [Chứng chỉ] Tag-input. |
| X-62 | Nhập tag trùng lặp | Tại màn hình Thêm cán bộ:<br>1. Nhập tag trùng nhau tại [Chứng chỉ] Tag-input.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Chứng chỉ đã tồn tại!"<br>Trỏ chuột tại [Chứng chỉ] Tag-input. |
| [Kích hoạt] Switch |
| X-63 | Không bật switch kích hoạt | Tại màn hình Thêm cán bộ:<br>1. Để switch ở trạng thái OFF tại [Kích hoạt] Switch.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng kích hoạt tài khoản!"<br>Trỏ chuột tại [Kích hoạt] Switch. |
| [Ảnh CCCD] Image |
| X-64 | Không upload ảnh CCCD | Tại màn hình Thêm cán bộ:<br>1. Không chọn ảnh tại [Ảnh CCCD] Image.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng upload ảnh CCCD!"<br>Trỏ chuột tại [Ảnh CCCD] Image. |
| X-65 | Upload ảnh không đúng định dạng | Tại màn hình Thêm cán bộ:<br>1. Chọn file không phải jpg, png tại [Ảnh CCCD] Image.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Chỉ chấp nhận file jpg, png!"<br>Trỏ chuột tại [Ảnh CCCD] Image. |
| X-66 | Upload ảnh quá dung lượng | Tại màn hình Thêm cán bộ:<br>1. Chọn ảnh > 5MB tại [Ảnh CCCD] Image.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Dung lượng ảnh không được vượt quá 5MB!"<br>Trỏ chuột tại [Ảnh CCCD] Image. |
| [Trình độ] Cascader |
| X-67 | Không chọn trình độ | Tại màn hình Thêm cán bộ:<br>1. Không chọn giá trị tại [Trình độ] Cascader.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng chọn trình độ!"<br>Trỏ chuột tại [Trình độ] Cascader. |
| X-68 | Chọn không đủ cấp độ | Tại màn hình Thêm cán bộ:<br>1. Chỉ chọn cấp cha, không chọn cấp con tại [Trình độ] Cascader.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng chọn đầy đủ cấp độ!"<br>Trỏ chuột tại [Trình độ] Cascader. |
| [Quyền truy cập] Transfer |
| X-69 | Không chuyển quyền nào | Tại màn hình Thêm cán bộ:<br>1. Không chuyển item nào sang bên phải tại [Quyền truy cập] Transfer.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng phân quyền cho cán bộ!"<br>Trỏ chuột tại [Quyền truy cập] Transfer. |
| [Mã OTP] OTP-input |
| X-70 | Không nhập mã OTP | Tại màn hình Thêm cán bộ:<br>1. Không nhập dữ liệu vào [Mã OTP] OTP-input.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng nhập mã OTP!"<br>Trỏ chuột tại [Mã OTP] OTP-input. |
| X-71 | Nhập mã OTP không đủ số | Tại màn hình Thêm cán bộ:<br>1. Nhập < 6 số tại [Mã OTP] OTP-input.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Mã OTP phải đủ 6 số!"<br>Trỏ chuột tại [Mã OTP] OTP-input. |
| X-72 | Nhập mã OTP sai | Tại màn hình Thêm cán bộ:<br>1. Nhập sai mã OTP tại [Mã OTP] OTP-input.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Mã OTP không chính xác!"<br>Trỏ chuột tại [Mã OTP] OTP-input. |
| [Ký tên] Signature |
| X-73 | Không ký tên | Tại màn hình Thêm cán bộ:<br>1. Không ký tại [Ký tên] Signature.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng ký tên xác nhận!"<br>Trỏ chuột tại [Ký tên] Signature. |
| X-74 | Ký tên quá đơn giản | Tại màn hình Thêm cán bộ:<br>1. Ký chỉ 1-2 nét tại [Ký tên] Signature.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Chữ ký không hợp lệ!"<br>Trỏ chuột tại [Ký tên] Signature. |
| [Vị trí làm việc] Map-picker |
| X-75 | Không chọn vị trí | Tại màn hình Thêm cán bộ:<br>1. Không chọn điểm trên bản đồ tại [Vị trí làm việc] Map-picker.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng chọn vị trí làm việc!"<br>Trỏ chuột tại [Vị trí làm việc] Map-picker. |
| X-76 | Chọn vị trí ngoài phạm vi cho phép | Tại màn hình Thêm cán bộ:<br>1. Chọn vị trí ngoài khu vực công ty tại [Vị trí làm việc] Map-picker.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vị trí không hợp lệ!"<br>Trỏ chuột tại [Vị trí làm việc] Map-picker. |
| [Mô tả công việc] Rich-text |
| X-77 | Không nhập mô tả công việc | Tại màn hình Thêm cán bộ:<br>1. Không nhập dữ liệu vào [Mô tả công việc] Rich-text.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng nhập mô tả công việc!"<br>Trỏ chuột tại [Mô tả công việc] Rich-text. |
| X-78 | Nhập quá số ký tự cho phép | Tại màn hình Thêm cán bộ:<br>1. Nhập quá 2000 ký tự tại [Mô tả công việc] Rich-text.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng không nhập quá 2000 ký tự!"<br>Trỏ chuột tại [Mô tả công việc] Rich-text. |
| [Code mẫu] Code-editor |
| X-79 | Không nhập code | Tại màn hình Thêm cán bộ:<br>1. Không nhập code tại [Code mẫu] Code-editor.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng nhập code mẫu!"<br>Trỏ chuột tại [Code mẫu] Code-editor. |
| X-80 | Nhập code có lỗi cú pháp | Tại màn hình Thêm cán bộ:<br>1. Nhập code sai cú pháp tại [Code mẫu] Code-editor.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Code có lỗi cú pháp!"<br>Trỏ chuột tại [Code mẫu] Code-editor. |
| [Đã kết hôn] Toggle |
| X-81 | Không chọn trạng thái | Tại màn hình Thêm cán bộ:<br>1. Không bật/tắt toggle tại [Đã kết hôn] Toggle.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng chọn tình trạng hôn nhân!"<br>Trỏ chuột tại [Đã kết hôn] Toggle. |
| [Thâm niên] Slider |
| X-82 | Không chọn giá trị | Tại màn hình Thêm cán bộ:<br>1. Không di chuyển slider tại [Thâm niên] Slider.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng chọn số năm kinh nghiệm!"<br>Trỏ chuột tại [Thâm niên] Slider. |
| [Bằng cấp] Tree-select |
| X-83 | Không chọn bằng cấp | Tại màn hình Thêm cán bộ:<br>1. Không chọn node nào tại [Bằng cấp] Tree-select.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng chọn bằng cấp!"<br>Trỏ chuột tại [Bằng cấp] Tree-select. |
| [Tài liệu] File-multiple |
| X-84 | Không upload tài liệu | Tại màn hình Thêm cán bộ:<br>1. Không chọn file nào tại [Tài liệu] File-multiple.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng upload tài liệu!"<br>Trỏ chuột tại [Tài liệu] File-multiple. |
| X-85 | Upload quá số file cho phép | Tại màn hình Thêm cán bộ:<br>1. Chọn > 5 file tại [Tài liệu] File-multiple.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Chỉ được upload tối đa 5 file!"<br>Trỏ chuột tại [Tài liệu] File-multiple. |
| X-86 | Upload file không đúng định dạng | Tại màn hình Thêm cán bộ:<br>1. Chọn file không phải pdf, doc, docx, xlsx tại [Tài liệu] File-multiple.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "File không đúng định dạng!"<br>Trỏ chuột tại [Tài liệu] File-multiple. |
| [Xác thực] Captcha |
| X-87 | Không xác thực captcha | Tại màn hình Thêm cán bộ:<br>1. Không nhập/check captcha tại [Xác thực] Captcha.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng xác thực!"<br>Trỏ chuột tại [Xác thực] Captcha. |
| X-88 | Xác thực captcha sai | Tại màn hình Thêm cán bộ:<br>1. Nhập sai mã captcha tại [Xác thực] Captcha.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Mã xác thực không đúng!"<br>Trỏ chuột tại [Xác thực] Captcha. |
| [Ghi âm] Audio |
| X-89 | Không ghi âm | Tại màn hình Thêm cán bộ:<br>1. Không ghi âm tại [Ghi âm] Audio.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng ghi âm giới thiệu!"<br>Trỏ chuột tại [Ghi âm] Audio. |
| X-90 | Ghi âm quá thời lượng | Tại màn hình Thêm cán bộ:<br>1. Ghi âm > 60s tại [Ghi âm] Audio.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Thời lượng không được vượt quá 60 giây!"<br>Trỏ chuột tại [Ghi âm] Audio. |
| [Video giới thiệu] Video |
| X-91 | Không quay video | Tại màn hình Thêm cán bộ:<br>1. Không quay video tại [Video giới thiệu] Video.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng quay video giới thiệu!"<br>Trỏ chuột tại [Video giới thiệu] Video. |
| X-92 | Quay video quá thời lượng | Tại màn hình Thêm cán bộ:<br>1. Quay video > 120s tại [Video giới thiệu] Video.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Thời lượng video không được vượt quá 120 giây!"<br>Trỏ chuột tại [Video giới thiệu] Video. |
| [Quét QR] QR-scanner |
| X-93 | Không quét mã QR | Tại màn hình Thêm cán bộ:<br>1. Không quét mã tại [Quét QR] QR-scanner.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng quét mã QR!"<br>Trỏ chuột tại [Quét QR] QR-scanner. |
| X-94 | Quét mã QR không hợp lệ | Tại màn hình Thêm cán bộ:<br>1. Quét mã QR không đúng định dạng tại [Quét QR] QR-scanner.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Mã QR không hợp lệ!"<br>Trỏ chuột tại [Quét QR] QR-scanner. |
| [Nhập giọng nói] Voice-input |
| X-95 | Không nhập bằng giọng nói | Tại màn hình Thêm cán bộ:<br>1. Không sử dụng voice input tại [Nhập giọng nói] Voice-input.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng nhập bằng giọng nói!"<br>Trỏ chuột tại [Nhập giọng nói] Voice-input. |
| X-96 | Giọng nói không rõ ràng | Tại màn hình Thêm cán bộ:<br>1. Nói không rõ tại [Nhập giọng nói] Voice-input.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Không nhận diện được giọng nói!"<br>Trỏ chuột tại [Nhập giọng nói] Voice-input. |
| [Chụp ảnh] Camera-capture |
| X-97 | Không chụp ảnh | Tại màn hình Thêm cán bộ:<br>1. Không chụp ảnh tại [Chụp ảnh] Camera-capture.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng chụp ảnh!"<br>Trỏ chuột tại [Chụp ảnh] Camera-capture. |
| X-98 | Ảnh chụp mờ/tối | Tại màn hình Thêm cán bộ:<br>1. Chụp ảnh chất lượng kém tại [Chụp ảnh] Camera-capture.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Chất lượng ảnh không đạt!"<br>Trỏ chuột tại [Chụp ảnh] Camera-capture. |
| [Loại nhân viên] Segmented |
| X-99 | Không chọn loại nhân viên | Tại màn hình Thêm cán bộ:<br>1. Không chọn segment tại [Loại nhân viên] Segmented.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng chọn loại nhân viên!"<br>Trỏ chuột tại [Loại nhân viên] Segmented. |
| [Ghi chú Markdown] Markdown |
| X-100 | Không nhập ghi chú | Tại màn hình Thêm cán bộ:<br>1. Không nhập dữ liệu vào [Ghi chú Markdown] Markdown.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng nhập ghi chú!"<br>Trỏ chuột tại [Ghi chú Markdown] Markdown. |
| X-101 | Nhập markdown sai cú pháp | Tại màn hình Thêm cán bộ:<br>1. Nhập markdown không đúng cú pháp tại [Ghi chú Markdown] Markdown.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Cú pháp markdown không đúng!"<br>Trỏ chuột tại [Ghi chú Markdown] Markdown. |
| Các button |
| X-102 | Không nhập dữ liệu vào form | Tại màn hình Thêm cán bộ:<br>1. Không nhập tất cả các dữ liệu được yêu cầu nhập trong form.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Vui lòng nhập dữ liệu!"<br>Trỏ chuột tại [Tên cán bộ] textbox. |
| X-103 | Xóa toàn bộ dữ liệu nhập vào. | Tại màn hình Thêm cán bộ:<br>1. Nhập vào các dữ liệu được yêu cầu nhập trong form.<br>2. Nhấn [Reset]button. | Hiển thị màn hình Thêm cán bộ với form còn trống.<br>Trỏ chuột tại [Tên cán bộ] textbox. |
| X-104 | Hủy việc thêm cán bộ. | Tại màn hình Thêm cán bộ:<br>Nhấn [Hủy] Button. | Hiển thị màn hình Danh sách cán bộ. |
| X-105 | Thêm cán bộ thành công khi input tất cả các thông tin | Tại màn hình Thêm cán bộ:<br>1. Nhập tất cả dữ liệu được yêu cầu nhập trong form.<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Thêm cán bộ thành công!" |
| X-106 | Thêm cán bộ thành công khi input tất cả các thông tin với data max length | Tại màn hình Thêm cán bộ:<br>1. Nhập tất cả dữ liệu được yêu cầu nhập trong form với data max length<br>2. Nhấn [Thêm] button. | Hiển thị thông báo: "Thêm cán bộ thành công!" |
| X-107 | Thêm cán bộ thành công khi chỉ input item bắt buộc nhập | Tại màn hình Thêm cán bộ:<br>1. Nhập data valid cho các item bắt buộc<br>2. Nhấn [Thêm] button | Hiển thị thông báo: "Thêm cán bộ thành công!" |
